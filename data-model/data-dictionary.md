...
| full_name | Имя пользователя | varchar | 100 | check: допускаются буквы кириллицы, латиницы, пробел и дефис | not null | Имя и фамилия мастера или имя клиента, введенное при онлайн-записи |
...
| status | Статус записи | varchar | 20 | check: значение входит в список `created`, `canceled`; default `created` | not null | `created` - создана; `canceled` - отменена |
