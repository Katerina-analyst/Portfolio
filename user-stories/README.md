...
- Клиент вводит имя и номер телефона
...
- В подтверждении отображаются параметры записи: категория и название процедуры, дата и время визита и рекомендации к визиту
- В подтверждении отображается информация, что ссылка для просмотра и отмены записи будет отправлена клиенту
...
**Связанные требования:** FRQ-12. Управление профилем мастера и каналами связи
...
**Критерии приемки:**
- Мастер может изменить свое имя
...
- После отмены записи система инициирует отправку уведомления мастеру
